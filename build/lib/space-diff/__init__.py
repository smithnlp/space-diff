...
def configure():
    ...
    """
    parser = argparse.ArgumentParser(description='This program highlights '
                                     'inconsistencies in the segmentation of '
                                     'any spaceless orthography training data')
...
def display(result_dict):
    ...
    global file_lengths
    print('\n')
    print('Printing variation matches for each multi-character token, noting',
          'the corpus and line number for each instance.')
    print('\n')
